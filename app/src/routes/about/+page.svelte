<script lang="ts">
	const sections = [
		...
		},
		{
			...
			body: 'Plurality with selectable ballot generators (sBT, sPL, CS) and Multiseat STV with configurable seats.'
		},
		{
			title: 'Results',
...
<div class="prose max-w-none prose-slate">
	<div
		class="not-prose mb-8 rounded-2xl border border-slate-200/70 bg-white/70 p-6 text-center shadow-sm backdrop-blur"
	>
	...
	<div
		class="not-prose mt-8 rounded-2xl border border-slate-200/70 bg-white/70 p-5 shadow-sm backdrop-blur"
	>
